...
public class MenuAdminResource {
  ...
  @GET
  @Path("/categories")
  public List<MenuCategoryResponse> listCategories(@PathParam("outletId") String outletId) {
    return menuAdminService.listCategories(outletId);
  }

  @POST
  @Path("/categories")
  public MenuCategoryResponse createCategory(@PathParam("outletId") String outletId, @Valid MenuCategoryUpsertRequest request) {
  ...
  public MenuCategoryResponse updateCategory(
    ...
    @Valid MenuCategoryUpsertRequest request
  ) {
  ...
  @DELETE
  @Path("/categories/{categoryId}")
  public void deleteCategory(@PathParam("outletId") String outletId, @PathParam("categoryId") String categoryId) {
    menuAdminService.deleteCategory(outletId, categoryId);
  }

  @GET
  @Path("/items")
  public List<MenuItemResponse> listItems(@PathParam("outletId") String outletId) {
    return menuAdminService.listItems(outletId);
  }

  @POST
  @Path("/items")
  public MenuItemResponse createItem(@PathParam("outletId") String outletId, @Valid MenuItemUpsertRequest request) {
  ...
  public MenuItemResponse updateItem(
    ...
    @Valid MenuItemUpsertRequest request
  ) {
  ...
  @DELETE
  @Path("/items/{itemId}")
  public void deleteItem(@PathParam("outletId") String outletId, @PathParam("itemId") String itemId) {
