...
public class LeadJob {
    ...
    // @Scheduled(every = "5m", identity = "lead-normalization-job") // DISABLED: Requires manual trigger
    ...
    // @Scheduled(every = "10m", identity = "lead-enrichment-job") // DISABLED: Requires manual trigger
    void runEnrichment() {
