  ...
  return (
    <div className="checkout-page">
      ...
      <style jsx>{`
        ...
        .pay-btn { max-width: 418px; margin: 0 auto; width: 100%; height: 56px; background: var(--text-primary); color: var(--bg-surface); border-radius: 16px; font-weight: 800; font-size: 14px; text-transform: uppercase; letter-spacing: 1px; display: flex; align-items: center; justify-content: center; gap: 12px; transition: var(--transition-fast); box-shadow: 0 12px 24px rgba(0,0,0,0.1); cursor: pointer; }
