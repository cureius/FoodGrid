...
import { ChevronLeft, ShieldCheck, Wallet, CreditCard, Landmark, CheckCircle2, Loader2, Lock } from 'lucide-react';
  ...
  if (isSuccess) {
    return (
        <div className="success-screen">
            ...
            <p className="success-meta">Transaction ID: #FG-9283-XT</p>
  ...
  return (
    <div className="checkout-page">
      ...
      <style jsx>{`
        ...
        .pay-btn { max-width: 418px; margin: 0 auto; width: 100%; height: 56px; background: var(--navy); color: white; border-radius: 16px; font-weight: 800; font-size: 14px; text-transform: uppercase; letter-spacing: 1px; display: flex; align-items: center; justify-content: center; gap: 12px; transition: var(--transition-fast); box-shadow: 0 12px 24px rgba(0,0,0,0.1); }
